...
ConVar
	...
	g_ConVarDelay,
	g_ConVarHibernate,
	g_ConVarUnloadExtNum,
	g_ConVarMinPeriodHours,
	g_ConVarLimitRebootHourStart,
	g_ConVarLimitRebootHourEnd,
	g_ConVarForceRebootHourStart,
	g_ConVarForceRebootHourEnd,
	g_ConVarDeltaUTC,
	g_ConVarStartRandomMap;
bool 
	g_bCvarEnabled,
	g_bStartRandomMap,
	g_bServerStarted;
int
	g_iCvarMethod,
	g_iCvarUnloadExtNum,
	g_iCvarMinPeriodHours,
	g_iCVarLimitRebootHourStart,
	g_iCVarLimitRebootHourEnd,
	g_iCVarForceRebootHourStart,
	g_iCVarForceRebootHourEnd,
	g_iHybernateInitial,
	g_iPluginRunDate;
float
	g_fCvarDeltaUTC,
	g_fCvarDelay;
char 
	g_sMapListPath[PLATFORM_MAX_PATH],
